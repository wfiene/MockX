...
def seed_items():
    rtx_4090 = Item(
        name='Nvidia RTX 4090', category='computer parts', color='silver', image='https://cdn.wccftech.com/wp-content/uploads/2022/09/NVIDIA-GeForce-RTX-4090-Graphics-Card-_1-low_res-scale-4_00x-Custom.png', price=1599, owner_id=1
    )
    xbox = Item(
        name='Xbox Series X', category='gaming console', color='black', image='https://media.wired.com/photos/5fa5dc3dba670daaf8e97a8d/191:100/w_1280,c_limit/games_gear_series-x.jpg', price=499, owner_id=2
    )
    playstation = Item(
        name='Playstation 5', category='gaming console', color='white', image='https://i5.walmartimages.com/asr/fd596ed4-bf03-4ecb-a3b0-7a9c0067df83.bb8f535c7677cebdd4010741c6476d3a.png?odnHeight=612&odnWidth=612&odnBg=FFFFFF', price=499, owner_id=3
    )
    jordan = Item(
    ...
    nike = Item(
        name='Nike Path WNTR', category='shoes', color='wheat', image='https://img.eobuwie.cloud/eob_product_512w_512h(1/7/3/4/17345f3aff677978a3a995bb91ae2395c9f22456_0000207720862_01_pa,jpg)/batai-nike-path-wntr-bq4223-700-wheat-wheat-black-cinnamon.jpg', price=110, owner_id=6
    )
    spin = Item(
        name='Spinnaker Cahill', category='watch', color='silver', image='https://cdn.shopify.com/s/files/1/0074/5432/6835/products/spinnaker-SP-5075-11-Q_1800x1800.jpg?v=1591119501', price=350, owner_id=1
    )
    shock = Item(
